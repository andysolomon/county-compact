...
Census modern cartographic files are useful for initial mockups but are not sufficient historical evidence. Their access was blocked during this research pass; confirm release-specific metadata before ingestion. Newberry's current About page explicitly releases Atlas data under CC0 1.0 Universal [S6]. Use its historical Georgia snapshot and chronology to establish the 1942 geometry, with Census as the modern crosswalk and topology comparison. Retain the CC0 statement and inspect the exact Georgia download metadata before bundling; independently check any disputed or ambiguous changes against the cited legal record.
...
| S6 | Newberry Library, [Atlas of Historical County Boundaries](https://publications.newberry.org/ahcb/) and [About the Atlas](https://publications.newberry.org/ahcb/about/) | County chronology, historical boundary research, official session-law basis, reuse terms | Read; About states CC0 1.0 Universal for Atlas data; exact Georgia download still to inspect |
...
|---|---|---|
| Q1 | Exact February 1942 county boundary snapshot and county roster | Compare Newberry chronology/Georgia dataset with state law and Census crosswalk; document every exception |
...
| Q9 | Asset/data rights | Preserve Census notices, Newberry CC0 statement and per-file metadata, font licenses, and original-icon provenance; separately clear any future archival media |
